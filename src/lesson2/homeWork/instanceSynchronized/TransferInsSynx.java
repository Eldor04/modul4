...
public class TransferInsSynx {
    public static void main(String[] args) {
        ...
        Runnable runnable1 = () -> account1.transfer(account1, account4, 400);
        Runnable runnable2 = () -> account1.transfer(account2, account4, 300);
        Runnable runnable3 = () -> account1.transfer(account3, account4, 200);
